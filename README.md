...
from AutoMQ commit `678f218`; no installer lockfile is claimed. The root launcher
is byte-identical to the copied payload and pins source commit `720cbe0`, which
