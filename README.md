...
from AutoMQ commit `0d5efc5`; no installer lockfile is claimed. The root launcher
is byte-identical to the copied payload and pins source commit `4769f88`, which
adopts colors-compute `ae28ea7`.
