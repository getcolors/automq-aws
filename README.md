...
from AutoMQ commit `ee5fd76`; no installer lockfile is claimed. The root launcher
is byte-identical to the copied payload and pins source commit `4bf8548`, which
